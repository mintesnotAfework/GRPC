...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x06number\">\n" +
	"\n" +
	"NumRequest\x12\x12\n" +
	"\x04from\x18\x01 \x01(\x03R\x04from\x12\x0e\n" +
	"\x02to\x18\x02 \x01(\x03R\x02to\x12\f\n" +
	"\x01n\x18\x03 \x01(\x03R\x01n\"9\n" +
	"\vNumResponse\x12\f\n" +
	"\x01i\x18\x01 \x01(\x03R\x01i\x12\x1c\n" +
	"\tremaining\x18\x02 \x01(\x03R\tremaining2>\n" +
	"\n" +
	"NumService\x120\n" +
	"\x03Rnd\x12\x12.number.NumRequest\x1a\x13.number.NumResponse0\x01B'Z%github.com/mintesnotAfework/GRPC/GRPCb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	0, // 0: number.NumService.Rnd:input_type -> number.NumRequest
	1, // 1: number.NumService.Rnd:output_type -> number.NumResponse
